...
function loadExternalTokens(_0, _1, _2, _3) {
  return __async(this, arguments, function* (config, request, response, options, performanceClient = new StubPerformanceClient()) {
    ...
    try {
      ...
      const cacheRecordAccount = yield invokeAsync(loadAccount, LoadAccount, logger, performanceClient, correlationId)(request, options.clientInfo || response.client_info || "", correlationId, storage, logger, cryptoOps, authority, idTokenClaims);
...
function loadAccount(request, clientInfo, correlationId, storage, logger, cryptoObj, authority, idTokenClaims) {
  return __async(this, null, function* () {
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-5Y7O5CDP.js");
    }
  } catch (e) {
  }
  return void 0;
...
*/
//# sourceMappingURL=chunk-WCS3VUGZ.js.map
